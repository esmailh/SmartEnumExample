...
//This other example implements a state machine. The method CanTransitionTo() returns true
//if it's allowed to transition from current state to next; otherwise returns false.
